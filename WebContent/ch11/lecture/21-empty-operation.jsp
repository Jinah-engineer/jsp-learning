...
<body>
	<div class="container">
		...
		<%-- Null 여부를 확인한다 -> true or false --%>
		<h1>empty 연산자</h1>		
		\${empty attr } Null 일 때: ${empty attr1 } <br>
		
		\${empty pageAttr1 } 빈 String 일 때: ${empty pageAttr1 } <br>
		...
		<h1>not empty 연산자</h1>
		\${not empty attr } Null 일 때: ${not empty attr1 } <br>
		
		\${not empty pageAttr1 } 빈 String 일 때: ${! empty pageAttr1 } <br>
		
		\${not empty pageAttr2 } 길이가 0인 배열 (x): ${! empty pageAttr2 } <br>
