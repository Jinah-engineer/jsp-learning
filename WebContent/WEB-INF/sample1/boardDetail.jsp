...
<div class="container mt-5">
	<div class="row justify-content-center">
		<div class="col-8">
		<h1>글 보기</h1>
			<form action="${pageContext.request.contextPath }/sample1/modify" id="form1" method="post">
				...
				<div class="form-group">
					<label for="user1">작성자</label>
					<input readonly value="${board.user }" type="text" name="user" class="form-contol" id="user1" />
				</div>
