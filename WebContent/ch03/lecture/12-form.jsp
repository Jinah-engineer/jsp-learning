			...
			<div class="col-6">
				<form>
					<div class="form-group">
						<label for="input1">이름</label> <input name="start"
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-6">
				...
				<!-- getParameter는 하나의 value만을 리턴하며 순서가 보장되지 않는다. -->
				<!-- 
				<p> fruit :request.getParameterValues("fruit")t") %> >> NullPointException / ArrayOutOfIndexException 발생 가능성
				-->
